...
BEGIN
  ...
  top_engaged AS (
    SELECT
      ...
      BOOL_OR(v.whatsapp_clicked) AS any_whatsapp,
      BOOL_OR(v.cta_clicked) AS any_cta,
...
GRANT EXECUTE ON FUNCTION public.proposals_pulse(integer) TO anon, authenticated;
