 ...
 *   - "evaluate" → GPT-5 com reasoning (avaliação profunda 3 dimensões)
 *   - "debrief"  → GPT-5 com reasoning high (análise final completa)
 *   - "objection"→ GPT-5 Mini (gera objeção contextual)
 *   - "loss"     → GPT-5 Mini (mensagem de perda motivada)
 *   - "deep"     → GPT-5 com reasoning high (análise profunda de melhoria)
 */
