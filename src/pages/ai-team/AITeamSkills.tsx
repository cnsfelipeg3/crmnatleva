...
const INITIAL_SKILLS: Skill[] = [
  { id: "s1", name: "Quebra de objeção de preço", category: "vendas", level: "avançado", successRate: 72, uses: 234, active: true, agents: ["NERO", "LUNA", "ATLAS"], description: "Técnicas para contornar objeções de preço com foco em valor agregado.", examples: ["'Entendo que o valor parece alto, mas deixe eu mostrar o que está incluído...'", "'Com parcelamento em 10x, fica equivalente a R$X por dia de viagem'"], trend: 8, createdAt: "2026-01-15T10:30:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s2", name: "Upsell de experiências", category: "upsell", level: "intermediário", successRate: 65, uses: 156, active: true, agents: ["HABIBI", "NEMO", "DANTE"], description: "Ofertar experiências premium no momento certo da conversa.", examples: ["'Para completar a experiência em Dubai, temos um jantar no deserto...'", "'Clientes que visitam Orlando adoram incluir o Kennedy Space Center'"], trend: 12, createdAt: "2026-02-01T14:00:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s3", name: "Acolhimento empático", category: "relacionamento", level: "básico", successRate: 91, uses: 412, active: true, agents: ["MAYA", "IRIS"], description: "Primeiro contato com tom humano e personalizado.", examples: ["'Que incrível que vocês estão planejando essa viagem! Me conta mais sobre o que vocês sonham...'"], trend: 3, createdAt: "2026-01-10T08:00:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s4", name: "Criação de urgência", category: "vendas", level: "avançado", successRate: 58, uses: 89, active: true, agents: ["NERO"], description: "Criar urgência real baseada em disponibilidade e sazonalidade.", examples: ["'Esse hotel tem apenas 2 quartos nessa categoria para as datas...'", "'A tarifa promocional expira em 48h'"], trend: -2, createdAt: "2026-02-20T16:45:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s5", name: "Follow-up inteligente", category: "relacionamento", level: "intermediário", successRate: 77, uses: 198, active: true, agents: ["ATLAS", "LUNA", "IRIS"], description: "Timing e conteúdo de follow-up baseado no perfil do cliente.", examples: ["'Oi [nome], vi que saiu uma promoção para o destino que você mencionou!'"], trend: 5, createdAt: "2026-01-25T11:20:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s6", name: "Resolução de reclamação", category: "suporte", level: "intermediário", successRate: 83, uses: 67, active: true, agents: ["ATHOS"], description: "Framework de resolução em 3 etapas: escutar, resolver, surpreender.", examples: ["'Entendo sua frustração e vou resolver agora...'", "'Além de corrigir o problema, preparamos uma surpresa especial'"], trend: 6, createdAt: "2026-03-05T09:00:00Z", createdBy: "Admin", originType: "learned" },
  { id: "s7", name: "Storytelling por destino", category: "comunicacao", level: "avançado", successRate: 69, uses: 145, active: false, agents: ["LUNA", "HABIBI", "DANTE", "NEMO"], description: "Narrar experiências de viagem como uma história envolvente.", examples: ["'Imagine acordar com vista para o Burj Khalifa...'"], trend: 15, createdAt: "2026-03-10T13:30:00Z", createdBy: "IA", originType: "learned" },
  { id: "s8", name: "Qualificação BANT", category: "vendas", level: "básico", successRate: 88, uses: 302, active: true, agents: ["ATLAS"], description: "Qualificar lead por Budget, Authority, Need, Timeline.", examples: ["'Já tem um orçamento em mente?'", "'Quando vocês gostariam de viajar?'"], trend: 1, createdAt: "2026-01-05T07:00:00Z", createdBy: "Admin", originType: "manual" },
  { id: "s9", name: "Reativação de lead frio", category: "relacionamento", level: "intermediário", successRate: 42, uses: 78, active: true, agents: ["AEGIS", "NURTURE"], description: "Reaquecer leads inativos com abordagem não invasiva.", examples: ["'Faz tempo que conversamos! Vi que tem promoção para o destino que você mencionou...'"], trend: -5, createdAt: "2026-03-20T15:00:00Z", createdBy: "Nath (IA)", originType: "nath_opinion" },
];
