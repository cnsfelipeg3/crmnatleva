...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border/20 bg-card text-card-foreground",
      "shadow-[0_4px_20px_hsl(150_40%_7%_/_0.12)]",
      "transition-all duration-[350ms] ease-[cubic-bezier(0.4,0,0.2,1)]",
      "hover:shadow-[0_8px_32px_hsl(150_40%_7%_/_0.22)] hover:-translate-y-[3px] hover:border-[hsl(var(--champagne)_/_0.15)]",
      className
    )}
    {...props}
  />
