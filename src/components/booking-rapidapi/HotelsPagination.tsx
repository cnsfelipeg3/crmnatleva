...
export function HotelsPagination({
  ...
  const totalPages = totalHotels ? Math.ceil(totalHotels / pageSize) : null;
  ...
  return (
    <div className="space-y-3 pt-4">
      {totalHotels !== null && totalPages !== null && (
        <p className="text-xs text-muted-foreground text-center">
          ...
          <strong className="text-foreground">{totalHotels.toLocaleString("pt-BR")}</strong> acomodações no total
        </p>
      )}
