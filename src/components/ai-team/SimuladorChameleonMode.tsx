  ...
  return (
    <div className="flex gap-4" style={{ height: "calc(100vh - 220px)" }}>
      ...
      <div className="flex-1 flex flex-col rounded-2xl overflow-hidden" style={{
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px]" style={{ color: "#64748B" }}>
                {phase === "debrief" ? "Sessão encerrada — Análise completa" : statusText || "Conversa em andamento..."}
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {phase === "running" && (
              <>
                <button onClick={handlePause} className="p-2 rounded-lg hover:bg-white/5 transition-colors">
                  <Pause className="w-4 h-4" style={{ color: "#94A3B8" }} />
                </button>
                <button onClick={handleSkipToDebrief} className="p-2 rounded-lg hover:bg-white/5 transition-colors">
                  <SkipForward className="w-4 h-4" style={{ color: "#94A3B8" }} />
                </button>
              </>
            )}
            {phase === "paused" && (
              <button onClick={handleResume} className="px-3 py-1.5 rounded-lg text-xs font-bold" style={{
            ...
            <button onClick={handleReset} className="p-2 rounded-lg hover:bg-white/5 transition-colors">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {phase === "debrief" && debrief ? (
            ...
            <>
              {messages.map((msg, i) => (
                <div key={i} className={cn("flex gap-2 max-w-[85%]", msg.role === "lead" ? "ml-auto flex-row-reverse" : "")}>
                  ...
                  >
                    {msg.role === "lead" ? <User className="w-3.5 h-3.5" /> : <Bot className="w-3.5 h-3.5" />}
                  </div>
      ...
      <div className="w-[280px] shrink-0 space-y-3 overflow-y-auto">
        ...
        {profile && (
          <div className="rounded-xl p-4" style={{
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                <p className="text-sm font-bold" style={{ color: "#E2E8F0" }}>{profile.nome}</p>
            ...
            <div className="space-y-1.5 text-[11px]" style={{ color: "#94A3B8" }}>
              ...
              <p>🧠 {profile.personalidade.join(", ")}</p>
            </div>
          </div>
        )}
        ...
        <div className="rounded-xl p-4" style={{
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl">{sentiment}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-medium" style={{ color: "#94A3B8" }}>Agente Atual</span>
              <span className="text-xs font-bold" style={{ color: "#6EE7B7" }}>
                {currentAgent?.emoji} {currentAgent?.name}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-medium" style={{ color: "#94A3B8" }}>Trocas</span>
        ...
        {/* Debrief score summary in sidebar */}
        {phase === "debrief" && debrief && (
