...
function TravelModeIndicator({ sale }: { sale?: PortalLayoutProps["travelSale"] }) {
  ...
  return (
    <div className="hidden 2xl:inline-flex shrink-0 items-center gap-2 px-2.5 py-1 rounded-full bg-accent/10 border border-accent/25 text-[10.5px] font-semibold text-accent whitespace-nowrap leading-none tracking-wide">
