...
const COUNTRY_ALIASES: Record<string, string> = {
  ...
  "jm": "jamaica", "aw": "aruba",
  // ISO-3 (códigos alpha-3)
  "bra": "brasil", "usa": "usa", "can": "canada", "mex": "mexico",
  "arg": "argentina", "chl": "chile", "per": "peru", "col": "colombia",
  "ury": "uruguai", "pry": "paraguai", "bol": "bolivia", "ecu": "equador",
  "ven": "venezuela",
  "fra": "franca", "ita": "italia", "esp": "espanha", "prt": "portugal",
  "deu": "alemanha", "ger": "alemanha", "gbr": "reino-unido", "sco": "escocia",
  "irl": "irlanda", "nld": "holanda", "hol": "holanda", "bel": "belgica",
  "che": "suica", "sui": "suica", "aut": "austria", "cze": "republica-tcheca",
  "hun": "hungria", "pol": "polonia", "swe": "suecia", "nor": "noruega",
  "dnk": "dinamarca", "den": "dinamarca", "fin": "finlandia", "isl": "islandia",
  "grc": "grecia", "gre": "grecia", "tur": "turquia", "hrv": "croacia",
  "rus": "russia",
  "jpn": "japao", "jap": "japao", "chn": "china", "kor": "coreia-do-sul",
  "tha": "tailandia", "idn": "indonesia", "vnm": "vietna", "ind": "india",
  "sgp": "singapura", "phl": "filipinas", "mdv": "maldivas", "hkg": "china",
  "twn": "taiwan", "mys": "malasia", "khm": "camboja", "lka": "sri-lanka",
  "npl": "nepal",
  "are": "emirados-arabes-unidos", "uae": "emirados-arabes-unidos",
  "qat": "catar", "mar": "marrocos", "egy": "egito", "zaf": "africa-do-sul",
  "rsa": "africa-do-sul", "isr": "israel", "jor": "jordania", "omn": "oma",
  "sau": "arabia-saudita", "ken": "quenia", "tza": "tanzania", "zwe": "zimbabue",
  "aus": "australia", "nzl": "nova-zelandia", "fji": "fiji", "pyf": "polinesia-francesa",
  "cub": "cuba", "dom": "republica-dominicana", "bhs": "bahamas",
  "jam": "jamaica", "abw": "aruba", "cuw": "curacao", "atg": "antigua",
  "brb": "barbados", "lca": "saint-lucia", "cri": "costa-rica", "pan": "panama",
  // PT/EN comuns
  "ee-uu": "usa", "estadosunidos": "usa", "estados-unidos": "usa",
  "eua": "usa",
