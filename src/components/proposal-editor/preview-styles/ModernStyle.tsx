    ...
    <div style={{ backgroundColor: bgCol, color: textCol }}>
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-1 h-8" style={{ backgroundColor: accentCol, boxShadow: `0 0 10px ${accentCol}40` }} />
      ...
      <section className="px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-2 gap-x-6 gap-y-2">
          {timeline.map((item, i) => {
            ...
            return (
              <div key={i} className="flex items-center gap-3 py-2 border-b group hover:bg-white/[0.02] transition-colors px-2 rounded" style={{ borderColor: `${accentCol}06` }}>
      ...
      <section className="px-8 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex rounded-lg overflow-hidden h-5 mb-2" style={{ backgroundColor: `${accentCol}10` }}>
            <div className="h-full flex items-center justify-center text-[8px] font-mono text-white font-bold" style={{ width: "10%", backgroundColor: accentCol, boxShadow: `inset 0 0 10px ${accentCol}60` }}>GRU</div>
            <div className="h-full flex items-center justify-center text-[8px] font-mono text-white" style={{ width: "50%", backgroundColor: `${accentCol}cc` }}>TOKYO · 8N</div>
            <div className="h-full flex items-center justify-center text-[8px] font-mono text-white" style={{ width: "25%", backgroundColor: `${accentCol}88` }}>KYOTO · 3N</div>
            <div className="h-full flex items-center justify-center text-[8px] font-mono text-white" style={{ width: "10%", backgroundColor: `${accentCol}55` }}>OSA</div>
      ...
      <section className="px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto space-y-3">
          {[
            { airline: "NH", name: "ANA · All Nippon Airways", flight: "NH 6284", from: "GRU", fromCity: "Guarulhos T3", to: "NRT", toCity: "Narita T1", dep: "23:45", arr: "06:30", dur: "24h45", date: "03 OUT", cls: "BUSINESS", aircraft: "Boeing 787-9", next: "+1", bag: "2×32kg", meal: "Jantar + Café + Almoço", seat: "THE Room (lie-flat 180°)", wifi: true, conn: "Escala IAH · 3h15" },
            { airline: "NH", name: "ANA · All Nippon Airways", flight: "NH 6283", from: "KIX", fromCity: "Kansai T1", to: "GRU", toCity: "Guarulhos T3", dep: "11:15", arr: "07:00", dur: "26h45", date: "18 OUT", cls: "BUSINESS", aircraft: "Boeing 777-300ER", next: "+1", bag: "2×32kg", meal: "Almoço + Jantar + Café", seat: "THE Room (lie-flat 180°)", wifi: true, conn: "Escala IAH · 4h20" },
          ].map((f, i) => (
            <div key={i} className="relative border overflow-hidden cursor-pointer group transition-all hover:shadow-lg" style={{ borderColor: `${accentCol}15`, borderRadius: "0.75rem", backgroundColor: `${accentCol}05` }} onClick={() => setExpandedFlight(expandedFlight === i ? null : i)}>
              <div className="absolute left-0 top-0 bottom-0 w-1 transition-all" style={{ backgroundColor: accentCol, boxShadow: `0 0 8px ${accentCol}40` }} />
                ...
                {expandedFlight === i && (
                  <div className="mt-4 pt-4 border-t grid grid-cols-4 gap-3" style={{ borderColor: `${accentCol}10` }}>
                    {[
                      ...
                      { icon: Star, label: "ASSENTO", val: f.seat },
                    ].map(d => (
                      <div key={d.label}>
          ...
          <div className="p-4 rounded-lg border" style={{ borderColor: `${accentCol}15`, backgroundColor: `${accentCol}05` }}>
            ...
            <p className="text-[10px] opacity-30 ml-8">Green Car (1ª classe) · Vista Mt. Fuji · JR Pass 7 dias incluído</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden h-[250px] relative mb-2">
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <h3 className="font-black text-lg" style={{ fontFamily: hFont }}>Aman Tokyo</h3>
          ...
          <div className="flex gap-1.5 mb-4">
            {hotelGallery1.map((img, j) => (
              <div key={j} className="flex-1 h-14 rounded-lg overflow-hidden cursor-pointer border-2 transition-all" style={{ borderColor: galleryIdx === j ? accentCol : "transparent", opacity: galleryIdx === j ? 1 : 0.4, boxShadow: galleryIdx === j ? `0 0 8px ${accentCol}30` : "none" }} onClick={() => setGalleryIdx(j)}>
                <img src={img} alt="" className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
          <div className="p-4 rounded-lg border" style={{ borderColor: `${accentCol}10` }}>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-mono opacity-30">Premier Room</span>
            </div>
            <div className="flex flex-wrap gap-1.5">
              {["Spa & Onsen", "Fitness 24h", "Lobby lounge", "Concierge", "Room service", "Lavanderia express"].map(a => (
      ...
      <section className="px-8 py-14">
        <div className="max-w-sm mx-auto text-center p-8 relative" style={{ borderRadius: "1rem" }}>
          ...
          <div className="relative z-10">
            <Zap className="w-5 h-5 mx-auto mb-4" style={{ color: accentCol, filter: `drop-shadow(0 0 8px ${accentCol}40)` }} />
            ...
            <p className="text-3xl font-black" style={{ fontFamily: hFont, color: accentCol, textShadow: `0 0 30px ${accentCol}20` }}>R$ 41.200,00</p>
            <p className="text-[10px] opacity-20 mt-2 font-mono">10× R$ 4.120 ou PIX R$ 39.140</p>
            <button className="mt-6 px-10 py-3 font-black text-sm text-white transition-all hover:scale-105" style={{ backgroundColor: accentCol, borderRadius: "0.75rem", fontFamily: hFont, boxShadow: `0 4px 20px ${accentCol}40` }}>
