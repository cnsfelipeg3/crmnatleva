...
export const mockTrips: MockTrip[] = [
  // ===== TRIP 1: Orlando - Family Disney =====
  {
    ...
    custom_title: "Orlando Mágica — Família Silva",
    ...
    sale: {
      id: "mock-orlando",
      name: "Orlando Mágica — Família Silva",
      status: "confirmada",
      origin_iata: "GRU",
  ...
  // ===== TRIP 2: Europa Romântica =====
  {
    id: "mock-europa",
    sale_id: "mock-europa",
    custom_title: "Europa Romântica — Paris, Roma & Santorini",
    ...
    sale: {
      id: "mock-europa",
      name: "Europa Romântica — Paris, Roma & Santorini",
      status: "confirmada",
      origin_iata: "GRU",
  ...
  // ===== TRIP 3: Maldivas (Concluída) =====
  {
    ...
    custom_title: "Maldivas — Lua de Mel dos Sonhos",
  ...
  // ===== TRIP 4: Patagônia (em andamento) =====
  {
    ...
    custom_title: "Patagônia Argentina — Aventura & Natureza",
