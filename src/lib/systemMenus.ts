...
export const SYSTEM_MENUS: SystemMenuItem[] = [
  ...
  { key: "cotacoes", label: "Cotações & Propostas", path: "/cotacoes", group: "Principal", actions: ALL },
  ...
  // --- Operação Diária ---
  { key: "operacao.inbox", label: "WhatsApp / Inbox", path: "/operacao/inbox", group: "Operação", actions: ALL },
