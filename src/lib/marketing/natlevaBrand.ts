...
export function buildBrandSystemPrompt(): string {
  ...
  return [
    ...
    "  · IMAGE 1 = the destination background photo · USE THIS as the actual background. Do NOT generate a different destination scene · keep the same composition, palette and recognizable landmarks.",
    "  · IMAGE 2 = the OFFICIAL NatLeva logotype (FOR REFERENCE ONLY).",
